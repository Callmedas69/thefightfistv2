  ...
  return (
    <ComingSoonContainer>
      <motion.div
        ...
        className="mt-8 bg-[#120029] py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        <div className="flex flex-row text-white">
          <TypeAnimation
            sequence={["WE", 1000, "ARE", 1000, "BUILDING", 1000]}
            wrapper="h1"
            cursor={true}
            repeat={Infinity}
          />
        ...
        <div className="text-white">
          something cool for <span className="text-orange-400">YOU</span>
        </div>
      </motion.div>
    </ComingSoonContainer>
  );
